...
shared.LoaderTitle = "Đăng Ký Kênh phucmax";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://94805804474489",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=94805804474489";
v24.Parent = v23;
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://94805804474489") then
                    return v729;
                end
            end
        end
...
v14:Notify({
    Title = "phucmax hub",
    Content = "Việt nam mãi đỉnh",
    Duration = 10
});



-- ⚡ Hiệu ứng viền phát sáng quanh menu (Xanh ngọc bích & Tím neon)
local UIS = game:GetService("UserInputService")
local TweenService = game:GetService("TweenService")

-- Đảm bảo có 'ScreenGui' và 'MainFrame' là GUI chính
local screenGui = game.CoreGui:FindFirstChild("PHUCMAX_UI") or Instance.new("ScreenGui", game.CoreGui)
...
-- Animation chuyển màu liên tục
task.spawn(function()
    while mainFrame and mainFrame.Parent do
        local tweenToPurple = TweenService:Create(glow, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
            Color = Color3.fromRGB(170, 0, 255)
        })
        tweenToPurple:Play()
        tweenToPurple.Completed:Wait()

        local tweenToCyan = TweenService:Create(glow, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
